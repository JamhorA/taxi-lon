...
drop materialized view if exists user_roles_with_email;
drop function if exists is_admin_base cascade;
drop function if exists refresh_user_roles_view cascade;
drop trigger if exists refresh_user_roles_view_trigger on "User_Roles";

-- Create base view instead of materialized view for real-time data
